...
export const TEMPLATES: TemplateDefinition[] = [
  ...
  // --- Photo (5) -----------------------------------------------------------
  {
    ...
    supportsPhoto: true,
    description:
      'A circular portrait sits at the top of a dark left rail with contact and skills beneath. Built for markets where a photo is expected.',
    bestFor: ['EU applications', 'Hospitality', 'Client-facing roles'],
    settingsDefaults: { accentColor: '#1e3a5f', photoShape: 'circle', photoSize: 'md', showPhoto: true },
    component: sidebar({
      sidebarSections: CREATIVE_SIDE,
      side: 'left',
      dark: true,
      headingStyle: 'underline-accent',
      photoPlacement: 'sidebar-top',
      sidebarWidth: '34%',
    }),
  },
  {
    ...
    supportsPhoto: true,
    description:
      'Photo beside your name in a full-width banner. Contact wraps under the title so long names stay readable.',
    bestFor: ['Consulting', 'Sales', 'Regional offices'],
    settingsDefaults: { accentColor: '#0f766e', photoShape: 'rounded', photoSize: 'md', showPhoto: true },
    component: singleColumn({
      headingStyle: 'underline-accent',
      headerVariant: 'banner',
      photoPlacement: 'header-left',
    }),
  },
  {
    id: 'photo-split',
    ...
    supportsPhoto: true,
    description:
      'Portrait and name in the dark half of a two-tone header, skills in a second column. Distinctive without crowding the story.',
    bestFor: ['Product', 'Startups', 'Creative operations'],
    settingsDefaults: { accentColor: '#4338ca', photoShape: 'circle', photoSize: 'sm', showPhoto: true },
    component: twoColumn({
      rightSections: ['technical-skills', 'soft-skills', 'languages', 'interests'],
      headingStyle: 'gradient-bar',
      headerVariant: 'split',
  ...
  },
  {
    ...
    supportsPhoto: true,
    description:
      'A tinted right rail holds the portrait, contact and skills so the main column stays a clean narrative.',
    bestFor: ['Design-adjacent roles', 'Studios', 'In-house creative'],
    settingsDefaults: { accentColor: '#1f2937', photoShape: 'rounded', photoSize: 'md', showPhoto: true },
    component: sidebar({
      sidebarSections: ['technical-skills', 'languages', 'interests'],
      side: 'right',
      tinted: true,
  ...
  },
  {
    ...
    supportsPhoto: true,
    description:
      'A centered portrait above the name, then a ruled single column. The classic European CV structure as selectable text.',
    bestFor: ['Germany and EU', 'Academia', 'Public sector'],
    settingsDefaults: {
      accentColor: '#334155',
      photoShape: 'circle',
      photoSize: 'lg',
